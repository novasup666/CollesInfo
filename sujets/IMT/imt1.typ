...
Soit $N in NN$. Soit $Sigma$ l'alphabet sur lequel sont définies $(u_k)_(0<=k<=N)$ et $(v_k)_(0<=k<=N)$ deux listes de mots. Soit $ Alpha = {a_0,...,a_(N-1)}$ des caractères disjoints de $Sigma$ (càd $Sigma inter A =  emptyset$). On définit les langages suivant, $forall n in NN$:
